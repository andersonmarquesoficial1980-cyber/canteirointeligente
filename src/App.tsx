...
import GestaoFrotasRastreamento from "./pages/GestaoFrotasRastreamento";
import GestaoFrotasMultas from "./pages/GestaoFrotasMultas";
...
import RelatorioMdoPeriodo from "./pages/RelatorioMdoPeriodo";
import RelatorioFuncionariosPersonalizado from "./pages/RelatorioFuncionariosPersonalizado";
...
import RelatorioNotasFiscaisConcreto from "./pages/RelatorioNotasFiscaisConcreto";
  ...
  return (
    <ErrorBoundary fallbackMessage="Erro ao carregar a página. Tente recarregar.">
      <Routes>
        ...
        <Route path="/gestao-pessoas/candidatos/:id" element={<RequireModule moduleId="gestao-pessoas"><FichaCandidato /></RequireModule>} />
        ...
        <Route path="/relatorios/mdo-periodo" element={<RequireModule moduleId="relatorios"><RelatorioMdoPeriodo /></RequireModule>} />
        <Route path="/relatorios/funcionarios-personalizado" element={<RequireModule moduleId="relatorios"><RelatorioFuncionariosPersonalizado /></RequireModule>} />
        ...
        <Route path="/relatorios/notas-fiscais-concreto" element={<RequireModule moduleId="relatorios"><RelatorioNotasFiscaisConcreto /></RequireModule>} />
