...
function exportarExcel(dataIni: string, dataFim: string, rows: InfraRow[]) {
  ...
  a.href = url;
  a.download = `WF_ProducaoPavimentacao_${dataIni}_a_${dataFim}.csv`;
  a.click();
...
function exportarPdf(dataIni: string, dataFim: string, rows: InfraRow[], filtros: string) {
  ...
  let html = `<!DOCTYPE html><html><head><meta charset="utf-8"><title>Produção de Pavimentação</title><style>
  ...
  <h1>🛣️ Relatório de Produção de Pavimentação</h1>
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="sticky top-0 z-40 bg-background/95 backdrop-blur border-b">
        <div className="max-w-7xl mx-auto px-4 py-4 flex items-center gap-3">
          ...
          <h1 className="text-lg font-bold text-foreground">Produção de Pavimentação</h1>
        </div>
      </div>
