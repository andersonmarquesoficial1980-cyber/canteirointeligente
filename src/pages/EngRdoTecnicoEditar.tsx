    ...
    const load = async () => {
      ...
      if (rdo) {
        setForm({
          ...
          usina_nao_atendeu_motivo: (rdo as any).usina_nao_atendeu_motivo || "",
          ...
          bgtc_m3: numToStr((rdo as any).bgtc_m3),
          macadame_m3: numToStr((rdo as any).macadame_m3),
          cauq_rima_ton: numToStr((rdo as any).cauq_rima_ton),
          bm25_ton: numToStr((rdo as any).bm25_ton),
          ...
          <>
            ...
            <div className={sectionCls}>
              ...
              <div>
                ...
                <div className="flex gap-3">
                  {["sim", "nao"].map(opt => (
                    <button key={opt} type="button" onClick={() => setForm((current) => ({
                      ...current,
                      usina_atendeu: opt,
